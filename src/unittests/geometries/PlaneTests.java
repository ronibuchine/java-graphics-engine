...
public class PlaneTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals("findIntersection() did not return the correct list for TC01", List.of(new Point3D(0, 0, 0)),
        ...
        assertEquals("findIntersection() did not return the correct value for TC04", List.of(new Point3D(1, 1, 0)),
                p1.findIntersections(r4));
